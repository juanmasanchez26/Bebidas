...
<section class="imagen-seccion">
    <img src="Imagenes/ruleta.jpg" alt="Imagen de ancho completo">
  
<div class="titulo">
<h1>Ruleta de Cocteles</h1>
</div>
...
<div class="gallery" id="drink-gallery">
    ...
    <button id="btnAleatorio" onclick="mostrarBebidaAleatoria()">Coctel Aleatorio</button>

<div class="aleatorio" id="bebidaAleatoriaInfo" style="display: none;">
    <img id="imagenBebida" alt="Imagen de la bebida">
    <p id="nombreBebida"></p>
    <a id="urlBebida" target="_blank"><button>Ver preparacion</button></a>
</div>

<script>
    function mostrarBebidaAleatoria() {
        var bebidas = document.querySelectorAll('.drink');

 
        var indiceAleatorio = Math.floor(Math.random() * bebidas.length);
        var bebidaAleatoria = bebidas[indiceAleatorio];

      
        var nombreBebida = bebidaAleatoria.getAttribute('data-name');
        var urlBebida = bebidaAleatoria.querySelector('a').getAttribute('href');
        var imagenBebidaSrc = bebidaAleatoria.querySelector('img').getAttribute('src');

       
        var nombreBebidaElement = document.getElementById('nombreBebida');
        var urlBebidaElement = document.getElementById('urlBebida');
        var imagenBebidaElement = document.getElementById('imagenBebida');

        nombreBebidaElement.textContent = nombreBebida;
        urlBebidaElement.href = urlBebida;
        urlBebidaElement.textContent = 'Ver Preparacion';
        imagenBebidaElement.src = imagenBebidaSrc;
        imagenBebidaElement.style.maxWidth = '25%'; 

   
        var bebidaAleatoriaInfo = document.getElementById('bebidaAleatoriaInfo');
        bebidaAleatoriaInfo.style.display = 'block';
    }
</script>
